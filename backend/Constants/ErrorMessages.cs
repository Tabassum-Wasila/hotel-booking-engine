...
{
    public const string CheckInRequired = "Check-in date is required";
    public const string CheckOutRequired = "Check-out date is required";
    ...
    public const string AdultRequired = "At least 1 adult is required";
    public const string MaximumAdultsAllowed = "Maximum 10 adults allowed";
    public const string ChildrenCannotBeNegative = "Children cannot be negative";
    public const string MaximumChildrenAllowed = "Maximum 6 children allowed";
    public const string GuestNameRequired = "Guest name is required";
    public const string GuestNameTooShort = "Guest name must be at least 2 characters";
    public const string GuestNameTooLong = "Guest name cannot exceed 100 characters";
    public const string InvalidEmailFormat = "Valid email address is required";
    public const string InvalidPhoneFormat = "Invalid phone number format";
    public const string ContactInfoRequired = "Either email or phone is required";
    public const string SpecialRequestsTooLong = "Special requests cannot exceed 500 characters";
